#!/usr/bin/env python3
"""
Improved Admin Panel with Better Authentication and Design
"""
                        ...
                        <div class="tribute-card">
                            <div class="tribute-header">
                                <div>
                                    ...
                                    ${tribute.relation_to_deceased ? `<div style="color: #666; font-size: 0.9rem;">${tribute.relation_to_deceased}</div>` : ''}
                                </div>
